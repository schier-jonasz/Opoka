<template>
  <header class="bg-[url('@/assets/img/hero-background.png')] h-[660px] w-full bg-no-repeat bg-cover bg-center rounded-4xl text-white flex items-center justify-center gap-20">
